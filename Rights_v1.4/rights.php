...
<?php 
        ...
        echo '</div>
          ...
          echo '</div>
                ...
                <div class="fourth lato">
                  <div class="active">
                    <select id="'; echo $id_up; echo'" name="update_grp" class="grp_user">
                      <option for="';echo  $resultat ['id']; echo '" value="/" ';
                          if($resultat["groupe"] == '/'){
                              echo " selected='selected' ";
                          }
                echo '>/</option>
                      <option for="';echo  $resultat ['id']; echo '" value="sti2d" ';
                          if($resultat["groupe"] == 'sti2d'){
                              echo " selected='selected' ";
                          }
                echo '>sti2d</option>
                      <option for="';echo  $resultat ['id']; echo '" value="electrotech" ';
 ...
 echo'<div class="save-rights">
        <div>
          <button class="btn save-button" type="submit" name="update"> Enregistrer </button>
        </div>
      </div>';
